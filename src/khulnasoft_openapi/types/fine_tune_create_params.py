...
class FineTuneCreateParams(TypedDict, total=False):
    ...
    classification_betas: Optional[Iterable[float]]
    ...
    You can select one of "ada", "babbage", "curie", or "davinci". To learn more
    about these models, see the [Engines](https://beta.khulnasoft.com/docs/engines)
    documentation.
    """
